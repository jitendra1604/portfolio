...
// Deterministic per-seed hash (FNV-1a) so a given route always renders the
// same generative pattern, but different routes look visually distinct.
...
export function OgBanner({
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", fontSize: 20, color: "#a3a3a3" }}>{footer}</div>
    </div>
  );
}
